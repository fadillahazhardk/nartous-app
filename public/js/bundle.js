      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'email or password is wrong');
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            (0, _alert.showAlert)('success', 'log out successfuly');
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'log out failed, try again!');
...
/*eslint-disable*/
var mapbox = function mapbox(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFkaWxsYWhhemhhcmRrIiwiYSI6ImNrZG11YzY2ODBtZzcyc3FpdTVvNHJnMDIifQ.2J9VYIS4enTbF1DB75xaaQ';
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); //we create new instance from FORMDATA to make object that accept multipart-form / files
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector('.btn--change_password').textContent = 'Save Password';
